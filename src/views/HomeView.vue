  ...
  <div class="page">
    ...
    <main class="main">
      <section class="section">
        <div class="container">
          <h2 class="section__title">Página Vendas</h2>
          <p class="section__text">Registre suas vendas de produtos de padaria de forma fácil.</p>
        </div>
      </section>
    ...
    <footer class="footer">
      ...
      <div class="footer__copyright">
        <p class="footer__copyright-text">© 2023 Grilo de Ouro. All rights reserved.</p>
      </div>
    </footer>
  </div>
</template>
